...
const StorekeeperSidebar = ({ isCollapsed, setIsCollapsed }) => {
    ...
    <>
      ...
      >
          ...
          <div className="flex items-center gap-4">
            ...
            {!isCollapsed && (
              ...
              >
                ...
                <span className="text-[10px] font-bold text-indigo-500 uppercase tracking-widest mt-1">Stock Management</span>
              </motion.div>
            )}
          </div>
        </div>
        ...
        <nav className="flex-1 px-4 space-y-2 overflow-y-auto no-scrollbar">
          <div className="mb-4">
            {!isCollapsed && (
              <span className="px-4 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Operational Console</span>
            )}
          </div>
            ...
            >
              ...
              {!isCollapsed && (
                <div className="flex flex-col text-left">
                  ...
                  <span className="text-[10px] font-bold text-slate-400 opacity-60">Close log</span>
                </div>
              )}
            </button>
